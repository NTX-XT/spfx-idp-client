...
import * as strings from 'NacFormsWebPartStrings';
import NacForms from './components/NacForms';
import { INacFormsProps } from './components/INacFormsProps';

export interface INacFormsWebPartProps {
  description: string;
  clientId: string;
  redirectUri: string;
  region: string;
...
export default class NacFormsWebPart extends BaseClientSideWebPart<INacFormsWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<INacFormsProps> = React.createElement(
      NacForms,
      {
